...
class EnableUnconditionalForward(SetForward):
...
EnableUnconditionalForward = EnableUnconditionalForward()
cti_command_registry.register_class(EnableUnconditionalForward)
